...
export default function ReportsClient({ reports }: { reports: any[] }) {
  ...
  async function handleSubmit() {
    ...
    if (!error && data) {
      ...
      setForm({ shop_name: '', river_name: '', report_text: '', water_temp: '', water_clarity: '', flies_working: '' });
      setShowForm(false);
      setSuccess(true);
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        {showForm && (
          <div style={{ background: '#fff', border: '1px solid #E5E7EB', borderRadius: '12px', padding: '1.5rem', marginBottom: '2rem' }}>
            <h2 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#111827', marginBottom: '1.25rem' }}>Post a conditions report</h2>

            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1rem' }}>
              <div>
                <label style={{ fontSize: '0.8rem', fontWeight: '600', color: '#374151', display: 'block', marginBottom: '4px' }}>Shop / Guide name *</label>
                <input
            ...
            <div style={{ marginBottom: '1rem' }}>
              ...
              <input
                ...
                placeholder="e.g. Hendrickson #14, BWO #18, Elk Hair Caddis"
                style={{ width: '100%', padding: '0.6rem 0.8rem', borderRadius: '8px', border: '1px solid #D1D5DB', fontSize: '0.9rem', color: '#111827' }}
              />
            </div>
        ...
        {allReports.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '4rem 2rem', color: '#9CA3AF' }}>
            ...
            <p style={{ fontSize: '0.9rem' }}>Be the first to post conditions for your local water</p>
          </div>
        ) : (
